...
@Getter
public class PostStudyUserListResponseDto extends ResponseDto {
    
    private PostStudyUserListResponseDto(String code, String message){
        super(code, message);
    }

    public static ResponseEntity<PostStudyUserListResponseDto> success() {
        PostStudyUserListResponseDto  result = new PostStudyUserListResponseDto(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
